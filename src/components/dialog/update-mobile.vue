<template>
  <Modal title="修改手机号码" v-model="modal" 
    ...
    <Form  
      ...
      <FormItem label="新手机号码" prop="mobile" >
        <Input type="text" 
     ...
     <FormItem label="图形验证码" class="imgCode" >
        ...
        <Input class="phone-input" 
          ...
          :maxlength="4" placeholder="输入图形验证码"   @on-change="changeMobile" />
           <i-col span="7"
      ...
      <FormItem label="验证码" prop="validationCode">
        ...
        <vaildate :mobile="formData.mobile"
          :disabled="valiDisabled" :captchaStr="formData.captchaStr">获取验证码</vaildate>
      </FormItem>
      <FormItem>
