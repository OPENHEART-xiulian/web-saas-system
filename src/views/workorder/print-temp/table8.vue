<template>
  ...
  <div>
    <div class="print-form">
      <div>
        <h2 class="title">{{store.storeName || '--'}}维修费用结算清单</h2>
      ...
      <table style="border-top: 1px solid #000;">
        <tr>
          <td colspan="2" class="print-form__label" style="width: 85px;">企业地址</td>
          <td colspan="6">{{getCityText(store.provinceCode) + getCityText(store.cityCode) + getCityText(store.countyCode) + store.address}}</td>
          <td colspan="2" class="print-form__label" style="width: 95px;">客服电话</td>
        ...
        <tr>
          ...
          <td colspan="2" class="print-form__label">送修人电话</td>
        ...
        <tr>
          ...
          <td colspan="2" class="print-form__label">车牌号</td>
          <td colspan="2">{{formData.plateNo || '--'}}</td>
          <td colspan="2" class="print-form__label">车型</td>
        ...
        <tr>
          ...
          <td colspan="2">{{formData.serviceAdvisorName || '--'}}</td>
          <td colspan="2" class="print-form__label">送修里程</td>
          <td colspan="2">{{formData.deliveryMileage || '--'}}km</td>
          <td colspan="2" class="print-form__label">送修油量</td>
          <td colspan="2">{{formData.repairFuel || '--'}}</td>
        </tr>
        <!-- <tr>
        ...
        <!-- <tr>
          ...
          <td colspan="8">{{store.socialCode || '--'}}</td>
        </tr> -->
        <!-- <tr>
          <td colspan="2" class="print-form__label">进厂日期</td>
          <td colspan="2">{{formData.deliveryDate | getDate }}</td>
          <td colspan="2" class="print-form__label">出厂日期</td>
          <td colspan="2">{{formData.factoryDate | getDate}}</td>
          <td colspan="2" class="print-form__label">出厂里程</td>
          <td colspan="2">{{formData.factoryMileage || '--'}}km</td>
          <td colspan="2" class="print-form__label">维修类别</td>
          <td colspan="2">{{formData.repairType | getRepairType}}</td>
        </tr> -->
        <!-- <tr>
          <td colspan="2" class="print-form__label">送修里程</td>
          <td colspan="4">{{formData.deliveryMileage || '--'}}km</td>
        </tr> -->
        <!-- <tr>
        ...
        <!-- 旧处理结果 -->
        <!-- <tr>
          <td colspan="2" class="print-form__label">旧处理结果</td>
          <td colspan="10">
        ...
        <tr>
          ...
          <td class="no-padding" colspan="12">
            <table>
              <tr class="no-border">
                <td colspan="12">1、结算清单项目及应付金额经双方核实，客户签字后生效。</td>
              </tr>
              <tr class="no-border" v-if="needRemark">
                <td colspan="12">
                  <div v-if="!isRemark">2、{{formData.workOrderRemark}}</div>
              ...
              <!-- <tr class="no-border">
                <td colspan="12">2、企业承诺本次维修质量保证期为车辆行驶<a class="unde">{{formData.warrantyMileage || 0}}</a>公里或者<a class="unde">{{formData.warranty || 0}}</a>日，里程和时间以先到者为准。</td>
              </tr> -->
              <!-- <tr class="no-border">
              ...
              <tr class="no-border">
                <td colspan="12">5、企业承诺本次维修的新能源汽车专用部件__________________维修质量保证期为________。</td>
              </tr> -->
              <tr class="no-border">
