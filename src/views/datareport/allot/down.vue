...
export default {
  data () {
    return {
      ...
      dataList: [
        {title: '调入配件数', value: '0', unit: '件'},
        {title: '调入总额', value: '0', unit: '元'},
      ...
      columns: [
        ...
        {title: '调拨申请单号', key: 'allotCode', width: 200},
  ...
  watch: {
    tableData (value) {
      if (value&&value.callInOutData) {
        this.dataList[0].value = value.callInOutData.callInComponentCount || 0;
        this.dataList[1].value = value.callInOutData.callInTotalCost || 0;
