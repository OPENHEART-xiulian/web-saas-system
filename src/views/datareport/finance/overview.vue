    ...
    <div class="overview-content">
      ...
      <Row>
        <i-col span="6" 
          ...
          :key="index"
          @click.native.stop="toList(item.key)">
          <div class="item">
...
export default {
  name: "DatareportFinanceOverview",
  data () {
    let lists = this.$permission.getPermissionTab('dataFinanceList');
    return {
      subStoreId: '',
      lists,
      storeList: [],
  ...
  methods: {
    ...
    toList (key) {
      this.$router.push('/datareport/finance/' + key + "?subStoreId=" + this.subStoreId);
    }
  },
}
</script>
