...
<script>
  import ReturnVisitList from "./returnvisit";  // 回访提醒
  import BirthdayList from "./birthday";        // 生日提醒
  import InsuranceList from "./insurance";      // 保险提醒
  import AnnualList from "./annual";            // 年检提醒
  import MaintainList from "./maintain";        // 保养提醒
  import RemindSetting from "./remind-setting"; // 提醒设置

  export default {
    components: { ReturnVisitList, BirthdayList, InsuranceList, AnnualList, MaintainList, RemindSetting },
    data () {
      let tabs = this.$permission.getPermissionTab("remindLabelList");
