<template>
  ...
  <div class="refund-add">
    ...
    <div class="box-shadow">
      <div class="refund-form">
        <div class="form-item">
          ...
          <span class="item-value">{{detail.purchaseCode || '--'}}</span>
        </div>
        <div class="form-item">
    ...
    <bottom-submit>
      ...
      <i-button v-if="detail.settleStatus === '1'&&this.$route.query.isSelfStore!='false'" type="error" :loading="loading" @click="toSettle">付款</i-button>
    </bottom-submit>
    <!-- <remind-dialog 
      ref="remindDialog"
      title="确定付款吗？"
